...
Após finalizar a instalação e inicialização, entre em contato com a nossa equipe através do [suporte](/suporte) para verificar se os eventos enviados pela SDK estão sendo recebidos corretamente.
